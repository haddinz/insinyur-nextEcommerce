...
function ProductEdit({ params }) {
    ...
    const uploadHandler = async (e) => {
        ...
        bodyFormData.append('file', file) //body form data tolong "tambahkan = append" file dari file
        try {
            dispatch({ type: 'UPLOAD_REQUEST'})
            const { data } = await axios.post('/api/admin/upload', bodyFormData, { //tempatkan = post
                headers: {
    ...
    const submitHandler = async ({
        ...
        try {
            ...
            // enqueueSnackbar(getError(err), { variant: 'error' })
            enqueueSnackbar( 'Some Else Wrong', { variant: 'warning'})
        }
    }
                        ...
                        <List>
                            ...
                            <NextLink href="/admin/products" passHref>
                                <ListItem selected button component="a">
                                    <ListItemText primary="Back Product"></ListItemText>
                                </ListItem>
                            </NextLink>
